...
export const metadata = {
  ...
  description:
    "Contact Sarkari Result for questions, feedback, or corrections. Reach out via email or phone for updates on Sarkari Naukri, Results, Admit Cards, and Government Exams across India.",
  keywords:
  ...
  alternates: { canonical: "https://sarkariresult.rest/contact" },
  openGraph: {
